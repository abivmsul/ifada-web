    ...
    <footer className="bg-gradient-to-r from-primary to-primary-80 text-white mt-12">
      <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <ul className="mt-2 space-y-1">
              ...
              <li><NavLink href="/about" className="hover:underline">About</NavLink></li>
              <li><NavLink href="/projects" className="hover:underline">Projects</NavLink></li>
              <li><NavLink href="/contact" className="hover:underline">Contact</NavLink></li>
            </ul>
          </div>
          <div>
            <h4 className="font-medium text-secondary">Community</h4>
            <ul className="mt-2 space-y-1">
              <li><NavLink href="/events" className="hover:underline">Events</NavLink></li>
              <li><NavLink href="/gallery" className="hover:underline">Gallery</NavLink></li>
              <li><NavLink href="/blog" className="hover:underline">Posts / News</NavLink></li>
              <li><NavLink href="/podcast" className="hover:underline">Podcasts</NavLink></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col items-start sm:items-start lg:items-end">
          ...
          <div className="mt-3">
            <NavLink href="https://t.me/ifadaislamicorg1"><Button href="https://t.me/ifadaislamicorg1" className="bg-secondary hover:bg-telegram">
